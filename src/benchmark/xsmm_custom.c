...
int main(int argc, char** argv) {
  ...
  if (xsmm_d->is_amx_kernel) {
    b_data = benchmark_xsmm_macroiter(b_prime_d, c_xsmm_d, n, xsmm_d, run_type);
  } else {
    b_data = benchmark_xsmm_macroiter(b_d, c_xsmm_d, n, xsmm_d, run_type);
  }
